    ...
    <div className="flex flex-col items-center justify-center min-h-screen px-8 bg-[#fafafa] dark:bg-[#050505]">
      <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in duration-700">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground font-medium">
              Sign in to your financial compass
            </p>
          </div>
        </div>
        ...
        <form
          ...
          className="space-y-5 bg-card/50 backdrop-blur-xl p-8 rounded-[2.5rem] border border-border/40 shadow-xl shadow-black/[0.03]"
        >
          <div className="space-y-2">
            <Label
              htmlFor="email"
              className="text-xs font-bold uppercase tracking-widest ml-1 opacity-70"
            >
              Email or Phone
            </Label>
            <Input
          ...
          {error && (
            <p className="text-destructive text-sm font-semibold ml-1 animate-pulse">
              {error}
            </p>
          )}
